...
int main(void) {
    ...
    int len = (int)strlen(message);
        ...
        printf("Sending v20 mss-negotiation+32bit-seq-ack+state-machine+byte-stream+flow-control+persist+adaptive-RTO+cc (window=%d mss=%u): \"%s\" (%d chars)\n\n",
