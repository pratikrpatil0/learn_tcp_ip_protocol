...
// FSM focus: SOCKET_SETUP -> READ_INPUT_BIT -> SEND_DATAGRAM -> CLOSE_SOCKET
...
int main(){  // the main entry point of the program where execution begins
    ...
    struct sockaddr_in receiver_addr;  // define a structure to hold the IP address and port number for the network connection
    ...
    printf("Enter a bit (0 or 1): ");  // print a human-readable log message to the console screen so we can see what is happening
